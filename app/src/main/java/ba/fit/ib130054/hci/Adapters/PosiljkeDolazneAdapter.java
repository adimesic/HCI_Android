...
/**
 * Created by Adi on 10-Aug-16.
 */
public class PosiljkeDolazneAdapter extends ArrayAdapter<Posiljke> {

    public PosiljkeDolazneAdapter(Context context, ArrayList<Posiljke> posiljke) {
